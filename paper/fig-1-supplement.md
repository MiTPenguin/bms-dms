...
- [<span class="toc-section-number">2</span> Chunk
  options](#chunk-options)
  - [<span class="toc-section-number">2.0.1</span> Packages](#packages)
  - [<span class="toc-section-number">2.0.2</span>
    Variables](#variables)
- [<span class="toc-section-number">3</span> Functions](#functions)
  - [<span class="toc-section-number">3.1</span>
    compute_difference](#compute_difference)
  - [<span class="toc-section-number">3.2</span> theme_pub](#theme_pub)
- [<span class="toc-section-number">4</span> Load and format
  data](#load-and-format-data)
- [<span class="toc-section-number">5</span> Load
  metadata](#load-metadata)
- [<span class="toc-section-number">6</span> Figures](#figures)
  - [<span class="toc-section-number">6.1</span> Fig S1x1 - Flow +
    IFNa-1,10,100 heatmaps](#fig-s1x1---flow--ifna-110100-heatmaps)
  - [<span class="toc-section-number">6.2</span> Fig S1x2](#fig-s1x2)
    - [<span class="toc-section-number">6.2.1</span> Fig S1x2-A -
      Barplots with LoF/GoF
      counts](#fig-s1x2-a---barplots-with-lofgof-counts)
    - [<span class="toc-section-number">6.2.2</span> Fig S1x2-B - stop
      effect density plots](#fig-s1x2-b---stop-effect-density-plots)
    - [<span class="toc-section-number">6.2.3</span> Fig S1x2-C -
      AlphaMissense](#fig-s1x2-c---alphamissense)
    - [<span class="toc-section-number">6.2.4</span> Fig S1x2-D -
      Fiducial variant forest
      plot](#fig-s1x2-d---fiducial-variant-forest-plot)
    - [<span class="toc-section-number">6.2.5</span> Fig S1x2-E -
      ClinVar annotation](#fig-s1x2-e---clinvar-annotation)
  - [<span class="toc-section-number">6.3</span> Merged Figure
...
D1 <- spikeins_join %>% 
  ...
  scale_fill_manual(values = c("GOF" = "#DC5E65",
                               "Unknown" = "white",
                               "LOF" = "#0072B2")
  ) +
  new_scale_fill() +
